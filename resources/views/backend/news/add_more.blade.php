    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group {!! APFrmErrHelp::hasError($errors, 'title') !!}">
                ...
                {!! Form::text('title[]', null, array('class'=>'form-control', 'id'=>'title', 'required' =>'required', 'placeholder'=>'Title')) !!}
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group {!! APFrmErrHelp::hasError($errors, 'description') !!}">
                ...
                {!! Form::textarea('description[]', null, array('class'=>'form-control', 'rows' => 3, 'required' =>'required', 'id'=>'description', 'placeholder'=>'Description')) !!}
