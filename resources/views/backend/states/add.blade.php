        ...
        <div class="col-md-12">
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-red-sunglo"> <span class="caption-subject bold">Add State</span> </div>
                </div>
                <div class="portlet-body form">          
                    {{-- <ul class="nav nav-tabs">              
                        <li class="active"> <a href="#Details" data-toggle="tab" aria-expanded="false"> Details </a> </li>
                    </ul> --}}
                    {!! Form::open(array('method' => 'post', 'route' => 'admin.save.state', 'class' => 'form', 'files'=>true)) !!}
