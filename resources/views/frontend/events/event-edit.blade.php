...
<section id="post-project-section">
  <form method="POST" action="{{ route('event.update', $project->id) }}" id="frm-add" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    <div class="container-fluid bgColor-white">
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input class="form-control datetimepicker" id="from_date" placeholder="Date" autocomplete="off" name="from_date" type="text" value="{{$project->from_date ?? ''}}">
        ...
        <div class="col-md-6">
          ...
          <input class="form-control datetimepicker" id="to_date" placeholder="End Date" autocomplete="off" name="to_date" type="text" value="{{$project->to_date ?? ''}}">
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input class="form-control" id="from_time" placeholder="From Time" autocomplete="off" name="from_time" type="time" value="{{$project->from_time ?? ''}}">
        ...
        <div class="col-md-6">
          <label>To <span class="mandatory">*</span></label>
          <input class="form-control" id="to_time" placeholder="To Time" autocomplete="off" name="to_time" type="time" value="{{$project->to_time ?? ''}}">
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <select class="form-control" id="recurrence" name="recurrence">
            <option value="1" {{ ($project->recurrence == 1)?'selected="selected"':'' }}>Every Week</option>
            <option value="2" {{ ($project->recurrence == 2)?'selected="selected"':'' }}>Every Month</option>
          </select>
            @error('recurrence')
            <p class="help-block"><strong>{{ $message }}</strong></p>
            @enderror
      ...
      <div class="row">
        <div class="col-md-12 pt-3">
          <button type="submit" class="create-project-btn">UPDATE EVENT &nbsp;&nbsp; <i class="fa fa-arrow-circle-o-right" aria-hidden="true"></i></button>
        </div>
      </div>
  </form>
</section>
