        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12 text-right add-project-area">
                    <span class="add-project-txt-title">Add Event</span>
                    <div><a href="{{ route('event.add') }}"><i class="fa fa-plus plus-icon" aria-hidden="true"></i></a></div>
                </div>
            </div>
            <div class="row pt-3">
                @if(count($projects) > 0)
                ...
                <div class="col-md-3"> 
                    <a href="{{ route('event.details', $project->id) }}">
