                    ...
                    <div class="row">
                        <div class="col-md-5">
                            ...
                            <h5 class="designation-txt">
                                <?php 
                                    $type = explode(',', \Config::get('global.profile_9_type'));
                                    if(isset($profile_overview->profession)) {
                                        echo $type[$profile_overview->profession];
                                        echo ' <i class="fa fa-user"></i> ('.$profile_overview->no_of_people.')';

                                        echo ($profile_overview->film_location == 1) ? ' <img src="' . asset('/') .'home/images/cinema.png" class="w-26" title="Film Location">' : '';

                                        echo ($profile_overview->pet_friendly == 1) ? ' <img src="' . asset('/') .'home/images/pet.png" class="w-26" title="Pet Friendly">' : '';
                                    }
