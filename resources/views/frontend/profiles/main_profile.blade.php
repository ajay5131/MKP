            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="profile-img-area">
                        ...
                        @else
                            <img src="{{ asset('/')}}uploads/profile_picture/{{$profile_overview->profile_pic}}" class="my-profile-img" onclick="openModal('media-info-modal', '{{route('load.media', ['media_id' => \General::getProfilePicMediaId($user_profile_id), 'user_profile_id' => $user_profile_id, 'profile_id' => $profile_id, 'tbl' => 'UsersProfilePicture'])}}')">
                        @endif
                        @if ($can_update)
                ...
                <div class="col-md-9">
                    <div class="row">
                        <div class="col-md-5">
                            ...
                            <h5 class="designation-txt">{{ $profile_overview->profession }}</h5>
