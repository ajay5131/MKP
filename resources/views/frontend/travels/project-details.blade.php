...
@section('content')
            ...
            <div class="row">
                ...
                <div class="col-md-6 text-center">
                    <h2 class="mb-0">Status :
                        {{ \Carbon\Carbon::parse($project->from_date)->format('d-m-Y') ?? '' }} </h2>
    ...
    <section id="banner-sec-3">
        ...
        <div class="container-fluid banner-posted-details">
            <img src="https://www.meetkeypeople.com/jobsportal/images/projects/1624397667.png"
                class="bann-img-details-page">
            <div class="row">

                <div class="col-md-2 text-right right-side-box">
                    <div class="plus-text-area">
                        <i class="fa fa-plus plus-icon plus-right-al" aria-hidden="true" data-toggle="modal"
                            data-target="#add_to_key_list"></i>
                    </div>
                    <p class="text-center bg-btn-col">Add to key list</p>
                    <div class="d-flex text-right right-align">
                        <div class="dropdown show">
                            <a class="btn btn-secondary dropdown-toggle dropdown-arrow f-w-m" href="#" role="button"
                    ...
                    <div class="llc-txt">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-1 text-right un-lock-area">
                                <i class="fa fa-unlock-alt un-lock" aria-hidden="true" data-toggle="modal"
                                    data-target="#unlock-llc"></i>
                            </div>
                        </div>
                            ...
                            <div class="description-box">
                                ...
                                @if (!$project_tags->isEmpty())
                                    @foreach ($project_tags as $key => $tag)
                                        <span
                                            class="badge badge-primary-{{ $key + 1 }}">{{ $tag->project_tag ?? '' }}</span>
                                    @endforeach
                                @endif
                            </div>
                        </div>
                    ...
                    <div class="row py-4">
                        ...
                        <div class="col-md-6 text-right">
                            <div class="d-flex align-v-center justify-content-end">
                                ...
                                <span class="plus-i-span" data-toggle="modal" data-target="#add_media"> <i
                                ...
                                <div class="col-sm-12">
                                    <div class="project-title-strip">
                                        <div class="mkp-white-border">
                                            ...
                                            <i class="fa fa-pencil w-pensil-col" aria-hidden="true" data-toggle="modal"
                                                id="edit-title" data-id=" {{ $val->id }}" data-title=" {{ $val->title }}"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div id="accordion">
                                    <div class="card" id="card-w">
                                        <div class="creator-flex">
                                            <span>Creator</span>
                                            <span>
                                                <i class="fa fa-angle-up" aria-hidden="true" data-toggle="collapse"
                                        ...
                                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                                            ...
                                            <div class="card-body card-body-custom">
                                                <div class="card custom-card" style="width:100%;">
                                                    <i class="fa fa-pencil profile-pic-pensil" aria-hidden="true"
                                                        data-toggle="modal" data-target="#added-from-modal"></i>
                                                    <img class="card-imgs"
                                                        src="{{ asset('/')}}uploads/profile_picture/{{$profile_overview->profile_pic}}"
                                                        alt="Card image cap">
                                                    <div class="card-body">
                                                        <p class="card-text">
                                    ...
                                    <div class="card" id="card-w">
                                        <div class="creator-flex">
                                            <span>Designer</span>
                                            <span>
                                                <i class="fa fa-angle-up" data-toggle="collapse" data-target="#collapseTwo"
                                        ...
                                        <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo"
                                            ...
                                            <div class="card-body card-body-custom">
                                                <div class="card custom-card" style="width:100%;">
                                                    <i class="fa fa-pencil profile-pic-pensil" aria-hidden="true"
                                                        data-toggle="modal" onclick="showDesignerInvesterModel('{{$designer->id }}')"></i>
                                                    <i class="fa fa-times card-close-red" aria-hidden="true"></i>
                                                    <img class="card-imgs"
                                                        src="{{ asset('/')}}uploads/{{$designer->image}}"
                                                        alt="Card image cap">
                                                    <div class="card-body">
                                                        <p class="card-text">
                                    ...
                                    <div class="card" id="card-w">
                                        ...
                                        <div id="collapseThree" class="collapse show" aria-labelledby="headingThree"
                                            ...
                                            <div class="card-body card-body-custom">
                                                <div class="card custom-card" style="width:100%;">
                                                    <i class="fa fa-pencil profile-pic-pensil" aria-hidden="true"
                                                        data-toggle="modal" onclick="showDesignerInvesterModel('{{ $investor->id }}')"></i>
                                                    <i class="fa fa-times card-close-red" aria-hidden="true"></i>
                                                    <img class="card-imgs"
                                                        src="{{ asset('/')}}uploads/{{$investor->image}}"
                                                        alt="Card image cap">
                                                    <div class="card-body">
                                                        <p class="card-text">
                                                        ...
                                                        <button class="btn view-application-btn">View Applications<span
                                                                class="white-circle-count">11</span></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
    ...
    <div class="modal fade" id="to_your_feed" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
    ...
    <div class="modal fade" id="add_to_key_list" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <!-- Modal  Start To your feed  -->
    <div class="modal fade" id="to_key_people" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <!-- Modal  Start To your feed  -->
    <div class="modal fade bd-example-modal-lg" id="unlock-llc" tabindex="-1" role="dialog"
    ...
    <!-- Modal Start   -->
    <div class="modal fade" id="add_social_media" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <!-- Modal  Start To your feed  -->
    <div class="modal fade bd-example-modal-lg" id="sort-title" tabindex="-1" role="dialog"
        aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <div class="modal fade  bd-example-modal-lg" id="add_media" tabindex="-1" role="dialog"
        aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <div class="d-flex">
                        ...
                        <div class="col-md-4" id="add_video">
                            <div class="new_music add-video-event" data-toggle="modal"
                                data-target="#add_soundcloud_spotify">
                                <div>
                                    <i class="fa fa-plus circle-icon-b" aria-hidden="true"></i>
                                    <p>Add Video</p>
                                </div>
                        ...
                        <form name="media_form" id="media_form_one" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-md-8 text-left">
                                ...
                                <input type="text" name="title" id="title" class="form-control"
                                    placeholder="Please enter the Description Title" required>
                        ...
                        <form name="media_form" id="media_form_three" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-md-12 py-1 text-left">
                                <div class="col-md-12 py-1">
                                    ...
                                    <input type="hidden" name="project_id" value="{{ request()->route('id') }}">
                                    <label class="mb-0">Under Title <span
                                ...
                                <div class="col-md-12 py-3">
                                    <div class="form-check">
                                        <input class="form-check-input coupon_question" name="youtube" type="checkbox"
    ...
    <div class="modal fade bd-example-modal-lg" id="edit-title-modal"  tabindex="-1" role="dialog"
        aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document"> 
            <div class="modal-content">
    ...
    <!-- Modal  Start To your feed  -->
    <div class="modal fade" id="added-from-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header add-b-border">
    ...
    <div class="modal fade bd-example-modal-lg" id="add-role-modal" tabindex="-1" role="dialog"
        aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
                ...
                <div class="modal-body text-left">
                    <div class="row">
                        ...
                        <div class="col-md-12" id="img-upload">
                            <div class="row d-flex">
                                <div class="col-md-6">
                                    ...
                                    <button onclick="HandleBrowseClick('input-image-hidden');"
                                        class="btn btn-primary custom-btn">UPLOAD IMAGE</button>
                                    <input style="display:none" name="image" id="input-image-hidden"
                        ...
                        <div class="col-md-12 pt-3">
                            <div class="row">
                                <div class="col-md-2">
                                    <label class="d-flex">Compensation <span
                                            class="mandatory">*</span></label>
                                </div>
                                <div class="col-md-3">
    ...
    <div class="modal fade bd-example-modal-lg" id="edit-role-modal" tabindex="-1" role="dialog"
        aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
                        ...
                        <div class="col-md-12" id="img-upload-edit">
                            <div class="row d-flex">
                                <div class="col-md-6">
                                    ...
                                    <button onclick="HandleBrowseClick('input-image-hidden');"
                                        class="btn btn-primary custom-btn">UPLOAD IMAGE</button>
                                    <input style="display:none" name="image" id="input-image-hidden-edit"
                                        onchange="document.getElementById('image-preview').src = window.URL.createObjectURL(this.files[0])"
                                        type="file" accept="image/jpeg, image/png"> 
                                </div>
                                <div class="col-md-6">
